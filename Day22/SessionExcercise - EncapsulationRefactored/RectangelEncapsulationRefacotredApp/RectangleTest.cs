using RectangelEncapsulationRefacotredApp.Models;

namespace RectangelEncapsulationRefacotredApp
{
    class RectangleTest
    {
        static void Main()
        {
            ...
            Console.WriteLine("hashcode of first " + firstRectangle.GetHashCode());
            ...
            Console.WriteLine("hashcode of second " + secondRectangle.GetHashCode());
